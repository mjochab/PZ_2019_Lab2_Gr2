...
public class NauczycielOcenyController {
    ...
    @FXML
    private TextField lbGrade;

    @FXML
    private TextField lbDetails;
    ...
    @FXML
    private Button printClassButton;

    @FXML
    private Button printStudentButton;
    ...
    void initialize(){
        ...
        this.addButton.disableProperty().bind(this.lbStudentName.textProperty().isEmpty()
                .or(this.lbGrade.textProperty().isEmpty())
                .or(this.lbDetails.textProperty().isEmpty())
